...
{
    internal class JShapeTetromino : Tetromino
    {
        ...
        public JShapeTetromino(ref bool[,] gameGrid)
        {
        ...
        public override void Rotate(int direction)
        {
            ...
            if (direction == 2 && !_isOnRest && _canRotate)
            {
                ...
                {
                    case 0:
                        if (!_gameGrid[_blocks[0].GetY() - 1, _blocks[0].GetX() + 1] && !_gameGrid[_blocks[2].GetY(), _blocks[2].GetX() + 2] && !_gameGrid[_blocks[3].GetY() + 1, _blocks[3].GetX() - 1])
                        {
                            _blocks[0].SetNewCoordinates(_blocks[0].GetX() + 1, _blocks[0].GetY() - 1);
                            _blocks[2].SetNewCoordinates(_blocks[2].GetX() + 2, _blocks[2].GetY());
                        ...
                        break;
                    case 1:
                        if (!_gameGrid[_blocks[0].GetY() + 1, _blocks[0].GetX() + 1] && !_gameGrid[_blocks[2].GetY() + 2, _blocks[2].GetX()] && !_gameGrid[_blocks[3].GetY() - 1, _blocks[3].GetX() - 1])
                        {
                            _blocks[0].SetNewCoordinates(_blocks[0].GetX() + 1, _blocks[0].GetY() + 1);
                            _blocks[2].SetNewCoordinates(_blocks[2].GetX(), _blocks[2].GetY() + 2);
                            _blocks[3].SetNewCoordinates(_blocks[3].GetX() - 1, _blocks[3].GetY() - 1);
        ...
        public override void CheckRest()
        {
            switch (_blocks.Count)
            {
                case 4:
                    switch (_rotationState)
                    {
                        ...
                        case 1:
                            ...
                            break;
                        case 2:
                            if (_gameGrid[_blocks[1].GetY() + 1, _blocks[1].GetX()] || _gameGrid[_blocks[2].GetY() + 1, _blocks[2].GetX()] || _gameGrid[_blocks[3].GetY() + 1, _blocks[3].GetX()])
                                _isOnRest = true;
                            else
                                _isOnRest = false;
                            break;
                ...
                case 3:
                    switch (_rotationState)
                    {
                        case 0 when _blocks[1].GetY() > _blocks[2].GetY():
                        ...
                        case 0:
                            if (_gameGrid[_blocks[0].GetY() + 1, _blocks[0].GetX()] || _gameGrid[_blocks[1].GetY() + 1, _blocks[1].GetX()] || _gameGrid[_blocks[2].GetY() + 1, _blocks[2].GetX()])
                                ...
                                _isOnRest = false;
                            break;
                        case 1 when _blocks[1].GetX() == _blocks[2].GetX():
                        ...
                        case 1:
                            if (_gameGrid[_blocks[1].GetY() + 1, _blocks[1].GetX()] || _gameGrid[_blocks[2].GetY() + 1, _blocks[2].GetX()])
                                ...
                                _isOnRest = false;
                            break;
                        case 2 when _blocks[0].GetX() != _blocks[1].GetX() || _blocks[0].GetX() != _blocks[2].GetX():
                            if (_gameGrid[_blocks[1].GetY() + 1, _blocks[1].GetX()] || _gameGrid[_blocks[2].GetY() + 1, _blocks[2].GetX()] || _gameGrid[_blocks[0].GetY() + 1, _blocks[0].GetX()])
                                _isOnRest = true;
                            else
                                _isOnRest = false;
                            break;
                        case 2:
                            if (_gameGrid[_blocks[1].GetY() + 1, _blocks[1].GetX()] || _gameGrid[_blocks[2].GetY() + 1, _blocks[2].GetX()])
                                ...
                                _isOnRest = false;
                            break;
                        case 3 when _blocks[1].GetX() == _blocks[2].GetX():
                    ...
                    switch (_rotationState)
                    {
                        case 0 when _blocks[0].GetY() != _blocks[1].GetY():
                            if (_gameGrid[_blocks[1].GetY() + 1, _blocks[1].GetX()])
                                ...
                                _isOnRest = false;
                            break;
                        case 1 when _blocks[1].GetX() == _blocks[0].GetX():
                            if (_gameGrid[_blocks[1].GetY() + 1, _blocks[1].GetX()])
                                _isOnRest = true;
                            else
                                _isOnRest = false;
                            break;
                        case 2 when _blocks[1].GetX() == _blocks[0].GetX():
                            if (_gameGrid[_blocks[1].GetY() + 1, _blocks[1].GetX()])
                                _isOnRest = true;
                            else
                                _isOnRest = false;
                            break;
                        case 3 when _blocks[1].GetX() == _blocks[0].GetX():
                            if (_gameGrid[_blocks[0].GetY() + 1, _blocks[0].GetX()])
                                _isOnRest = true;
                            else
                                _isOnRest = false;
        ...
        public override void Destroy()
        {
            ...
            TetrominoDestroyed?.Invoke(this, EventArgs.Empty);
        }
    }
}