...
{
    internal class LShapeTetromino : Tetromino
    {
        ...
        public LShapeTetromino(ref bool[,] gameGrid)
        {
        ...
        public override void CheckRest()
        {
            switch (_blocks.Count)
            {
                    ...
                    switch (_rotationState)
                    {
                        ...
                        case 1:
                            if (_gameGrid[_blocks[1].GetY() + 1, _blocks[1].GetX()] || _gameGrid[_blocks[2].GetY() + 1, _blocks[2].GetX()])
                                ...
                                _isOnRest = false;
                            break;
                        case 2 when _blocks[1].GetY() > _blocks[2].GetY():
                            if (_gameGrid[_blocks[1].GetY() + 1, _blocks[1].GetX()] || _gameGrid[_blocks[2].GetY() + 1, _blocks[2].GetX()] || _gameGrid[_blocks[0].GetY() + 1, _blocks[0].GetX()])
                                _isOnRest = true;
                            else
                                _isOnRest = false;
                            break;
                        case 2:
                            if (_gameGrid[_blocks[1].GetY() + 1, _blocks[1].GetX()] || _gameGrid[_blocks[0].GetY() + 1, _blocks[0].GetX()])
                                _isOnRest = true;
                            else
                                _isOnRest = false;
                            break;
                ...
                case 2:
                    switch (_rotationState)
                    {
                        case 0 or 1 when _blocks[1].GetX() == _blocks[0].GetX():
                            if (_gameGrid[_blocks[1].GetY() + 1, _blocks[1].GetX()])
                                _isOnRest = true;
                            else
                                _isOnRest = false;
                            break;
                        case 2 or 3 when _blocks[1].GetX() == _blocks[0].GetX():
                            if (_gameGrid[_blocks[0].GetY() + 1, _blocks[0].GetX()])
                                _isOnRest = true;
                            else
                                _isOnRest = false;
